            ...
            <div class="card">
              <div class="card-header">
                  <div class="row">
                    ...
                    <div class="col-md-2">
                      <a href="javascript:void(0)" class="btn btn-primary mt-32 pull-right" title="Add Salesmen" data-toggle="modal" data-target="#modal-lg"><i class="fas fa-plus"></i> Add Salesmen</a>
                    </div>
                  </div>
              </div>
            </div>
